...
cd /var/www/list-it-bro-product/backend && bundle exec rails runner -e production 'Batch::DealAppAccessToken.update' >> /var/www/list-it-bro-product/backend/log/cron.log 2>&1
